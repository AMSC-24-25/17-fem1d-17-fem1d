...
// Compute 2D triangle measure (area): 0.5 * |AB × AC|
template<>
...
// Compute 3D tetrahedron measure (volume): |(AB × AC) · AD| / 6
template<>
...
// Compute gradient of i-th 1D barycentric shape function: ∇λᵢ
template<>
...
// Compute gradient of i-th 2D barycentric shape function: ∇λᵢ (constant on triangles)
template<>
...
// Compute gradient of i-th 3D barycentric shape function: ∇λᵢ (constant on tetrahedra)
template<>
